...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    // Scroll fires far more often than once per frame during inertial/fast
    // scrolling; coalesce to at most one getBoundingClientRect()+resize per
    // animation frame instead of doing it on every raw scroll event.
    let scrollRaf = 0
    const onScroll = () => {
